...
const struct Config init_config = {
			.version				= 0x03,		/*def 0x01 */
			.protocol				= DSM_MITM,	/*def DSM_MITM*/
			.protocol_start 			= true,
			.debug_enable 				= true,			/* def false */
			.debug_button				= true,
			...
			.dsm_bind_channel			= -1,
			.dsm_bind_mfg_id			= {0x61, 0xE7, 0xD9, 0xF5},     /*dx7s id {0x61, 0xE7, 0xD9, 0xF5}, dx6i:{0x85, 0xE2, 0x76, 0x86}*/    
			.dsm_protocol				= 0x12,				/*def 0x01 , dx6i:0x03 , dx7s:0x12*/
			.dsm_num_channels			= 7,				/*def 6*/ 
			.dsm_force_dsm2				= true,			/*def false*/
